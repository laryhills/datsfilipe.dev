    ...
    <header className='flex fixed z-10 justify-between items-center p-4 w-screen bg-opacity-20 dark:bg-opacity-5 bg-neutral-100 backdrop-blur-sm dark:bg-neutral-700'>
      <div className='flex items-center'>
        ...
        <a
          ...
          className='ml-3 text-xl transition-all hover:text-2xl hover:text-orange-500 max-lg:ml-0 text-stone-600 dark:text-neutral-300 hover:dark:text-orange-500'
          target='_blank'
          rel='noreferrer'
        >
          <FaGithub />
